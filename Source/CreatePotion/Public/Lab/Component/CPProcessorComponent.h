...
enum class EProcessorBlockReason
{
	None,
	Disabled,
	NotProcessingPhase,
...
protected:
	...
	virtual EProcessorBlockReason EvaluateInteraction() const;
	virtual EProcessorBlockReason EvaluateIngredient(const ACPAlchemyProp* ItemInstance) const;
